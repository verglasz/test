...
class StanModelController {
  ...
  runData(data) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      promises_1.default.writeFile(
        path_1.default.join(this.cwd, filename),
        JSON.stringify(data)
      );
      ...
      const output = yield services_1.csvService.readNumericCsv(
        path_1.default.join(this.cwd, "output.csv")
      );
      const p = output["p"];
  ...
  uncheckedRunFile(datafile, outfile = "output.csv") {
    return services_1.cmdService.execute(
      path_1.default.join(this.cwd, "model"),
