    ...
    runData(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield new Promise((resolve, reject) => {
                var _a, _b, _c, _d;
                (_a = execution.execution.stdin) === null || _a === void 0 ? void 0 : _a.on('finish', resolve);
                (_b = execution.execution.stdin) === null || _b === void 0 ? void 0 : _b.on('error', reject);
                (_c = execution.execution.stdin) === null || _c === void 0 ? void 0 : _c.write(strData);
                (_d = execution.execution.stdin) === null || _d === void 0 ? void 0 : _d.end();
            });
